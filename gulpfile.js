...
function bundle() {
    ...
    plugins: [
      new webpack.DefinePlugin({
        ...
        'process.env': {
          ...
          MILLENIUM_MODE: JSON.stringify(__MILLENIUM__),
          WEBSOCKET: JSON.stringify(__WEBSOCKET__),
          STYLES: JSON.stringify(false),
        },
      }),
  ...
  .pipe(rename({ basename: pkg.name + '-v' + pkg.version }))
